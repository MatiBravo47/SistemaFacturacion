...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// btnAgregar
			// 
			this->btnAgregar->Location = System::Drawing::Point(591, 204);
			...
			// btnModificar
			// 
			this->btnModificar->Location = System::Drawing::Point(648, 233);
			...
			this->btnCargarProductos->Click += gcnew System::EventHandler(this, &FormDeposito::btnCargarProductos_Click);
			// 
			// FormDeposito
			// 
